...
IO::IO(int num_points, int num_k , std::vector<int>max_dim_vec): num_points(num_points)
 , num_k(num_k) , max_dim_vec(max_dim_vec){//Can I implement max values input, within the constructor??
